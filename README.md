...
<head>
    ...
    <title>Love Login by Savage</title>
...
<body>
    ...
    <script>
        ...
        const secretCode = 'Smriti'; // Replace with your secret code
        ...
        form.addEventListener('submit', (e) => {
            ...
            if (userInput === secretCode) {
                ...
                resultDiv.innerHTML = 'Naa Tum meri baby nhi hoo kon hooo tum kaha hai meri Smriti💗';
            }
        });
